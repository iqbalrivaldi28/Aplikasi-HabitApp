...
class CountDownActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val countDownTV = findViewById<TextView>(R.id.tv_count_down)

        viewModel.setInitialTime(habit.minutesFocus)
        viewModel.currentTimeString.observe(this) { counting ->
            countDownTV.text = counting
        }
        ...
        findViewById<Button>(R.id.btn_start).setOnClickListener {
            val habitData = workDataOf(HABIT_ID to habit.id, HABIT_TITLE to habit.title)
